/*
* changeImage
* Change christmas tree image on click for first christmas tree
*/
function changeImage() {
    event.preventDefault();

    if (
        document.getElementById("danu-baltegle").src ==
        "https://eglitetev.lv/egles/3.jpg"
    ) {
        document.getElementById("danu-baltegle").src =
        ...
        document.getElementById("danu-baltegle").src =
            "https://eglitetev.lv/egles/nordman/1c2b303b-f043-45b5-8ec0-1d9697fcb503.JPG";
    } else if (
        document.getElementById("danu-baltegle").src ==
        "https://eglitetev.lv/egles/nordman/1c2b303b-f043-45b5-8ec0-1d9697fcb503.JPG"
    ) {
        document.getElementById("danu-baltegle").src =
            "https://eglitetev.lv/egles/nordman/IMG_7391.JPG";
    } else if (
        document.getElementById("danu-baltegle").src ==
        "https://eglitetev.lv/egles/nordman/IMG_7391.JPG"
    ) {
        document.getElementById("danu-baltegle").src =
            "https://eglitetev.lv/egles/nordman/IMG_7437.JPG";
    } else if (
        document.getElementById("danu-baltegle").src ==
        "https://eglitetev.lv/egles/nordman/IMG_7437.JPG"
    ) {
...
/*
* changeImage
* Change christmas tree image on click for second christmas tree
*/
function changeImageLV() {
    event.preventDefault();

    if (
        document.getElementById("lat-egle").src ==
        "https://eglitetev.lv/egles/lat/IMG_4567.jpg"
    ) {
        document.getElementById("lat-egle").src =
            "https://eglitetev.lv/egles/lat/IMG_4568.jpg";
    } else {
        document.getElementById("lat-egle").src =
            "https://eglitetev.lv/egles/lat/IMG_4567.jpg";
    }
